...
## 1.GCC
### 1.1 GCC 是什么
    gcc一个编译器套件，其包含有各种语言的编译器和依赖的库文件
### 1.2 GCC 如何使用
```
gcc test.c -o app
...
![adb8e33dc7068349c535c48f199168bc.png](en-resource://database/3546:1)
...
### 2.2 Makefile文件命名和规则
![0cc5aca7ba2231367ad956e6839f607f.png](en-resource://database/3548:1)

### 2.3 Makefile工作原理
![37c2cf56d1c04a476982ec2c038149ab.png](en-resource://database/3550:1)

### 2.4 Makefile中的变量
![3205fc5bf818533bd87380dd7ca77d17.png](en-resource://database/3552:1)

### 2.5 Makefile中的模式匹配
![2d1f71840a24b19dc0ed6510fb31e802.png](en-resource://database/3554:1)

### 2.6 Makefile中的函数
![596df5e03cd5ac40b5df3609ed5fe113.png](en-resource://database/3556:1)

![9437280ae59072f9a8871acf454a498b.png](en-resource://database/3558:1)

## 3.GDB
### 3.1 GDB是什么？

![74363a244a67299c30afce15cfca06ff.png](en-resource://database/3668:1)
...
### 3.2 GDB调试的准备工作
![9e4ef5b1f8a6d2f2a341d3e79e237773.png](en-resource://database/3670:1)

### 3.3 GDB的使用——启动、退出、查看源码
![0f1a8b72930eec8a75a10a7eca1b8304.png](en-resource://database/3672:1)

### 3.4 GDB的使用——断点
![921ec5d1f7934ca80f2ca1559e833949.png](en-resource://database/3674:1)

### 3.5 GDB的使用——调试命令
![32c0799070a9377b42d543337aecea94.png](en-resource://database/3676:1)

* * *
```
调试命令汇总
```
![e97813b4af1a6f67812df4be349edf1d.png](en-resource://database/3678:1)

* * *
![4ae85facc029d5283fc0ead5c06e4a02.png](en-resource://database/3680:1)
...
![0d653ee08ed4872ea43c47fb5c56ea0f.png](en-resource://database/3682:1)
...
![68361847349589986dd9f9a739cdcdd4.png](en-resource://database/3703:1)

这里面有一个st_mode变量，他的结构如下
![df112db9e80dab8e8a631a37c70cc113.png](en-resource://database/3701:1)
